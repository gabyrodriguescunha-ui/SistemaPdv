...
// Define um produto adicionado ao pedido
...
// Elementos do cupom
const campoCupom = document.querySelector<HTMLInputElement>("#codigo-cupom");

const botaoAplicarCupom = document.querySelector<HTMLButtonElement>("#aplicar-cupom");

const mensagemCupom = document.querySelector("#mensagem-cupom");

// Botão de finalizar
const botaoFinalizar = document.querySelector<HTMLButtonElement>("#finalizar-pedido");

// Elementos do modal de mensagens
const modalMensagem = document.querySelector<HTMLDialogElement>("#modal-mensagem");
const modalIcone = document.querySelector("#modal-icone");
const modalTitulo = document.querySelector("#modal-titulo");
const modalTexto = document.querySelector("#modal-texto");

const botaoFecharModal = document.querySelector<HTMLButtonElement>("#fechar-modal");
...
function adicionarProduto(idProduto: number): void {
...
// Aumenta a quantidade
function aumentarQuantidade(idProduto: number): void {
...
function diminuirQuantidade(idProduto: number): void {
  const itemEncontrado = pedido.find(function (item) {
    return item.id === idProduto;
  });
...
// Remove um produto
function removerProduto(idProduto: number): void {
...
function verificarRegraCupom(subtotal: number): void {
  if (!mensagemCupom) {
    return;
  }
...
function mostrarModal(titulo: string, mensagem: string, icone: string): void {
